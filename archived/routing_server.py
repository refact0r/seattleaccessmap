"""
Flask API server for accessibility routing calculations.

Provides REST endpoint for calculating accessible routes dynamically.
"""
...
# Global variables to cache the graph and barrier data
G = None
G_proj = None
df_barriers = None
barrier_tree = None
...
def initialize():
    """Load graph and barrier data once at startup."""
...
def calculate_edge_costs():
    """Pre-calculate accessibility costs for all edges in the graph."""
